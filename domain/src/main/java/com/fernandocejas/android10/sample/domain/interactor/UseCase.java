...
public abstract class UseCase {
	...
	protected abstract Observable buildCreateUseCaseObservable(int userId);
	...
	public void getUsers(Subscriber UseCaseSubscriber) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void createUser(Subscriber UseCaseSubscriber, int userId) {
		this.subscription = this.buildCreateUseCaseObservable(userId)
				.subscribeOn(Schedulers.from(threadExecutor))
				.observeOn(postExecutionThread.getScheduler())
				.subscribe(UseCaseSubscriber);
	}
